      ...
      <MainGrid $showSidebar={showSidebar && !isModal}>
        ...
        <Workspace>
          ...
          {selectedPatient ? (() => {
            ...
            const pDoctor = selectedPatient.doctor_name || selectedPatient.doctorName || selectedPatient.admittingDoctorName || selectedPatient.admittingDoctor || selectedPatient.consultingDoctorName || selectedPatient.patient?.doctorName || '';
              ...
              <>
                <CompactPatientRibbon $isFinal={formData.is_finalized}>
                      ...
                      <div className="bottom-row">
                        ...
                        {pDoctor && (
                          <span className="visual-chip doctor-chip" title="Attending Doctor">
                            👨‍⚕️ <strong>{pDoctor.replace(/^Dr\.?\s+/i, 'Dr. ')}</strong>
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="note-meta-inline">
                    <div className="type-select-wrap" title="Select Note Type">
