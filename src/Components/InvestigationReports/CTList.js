...
const CTList = ({ billTypeNo = "CT01", investBillNo: investBillNoFilter }) => {
  ...
  const canEdit = allowedActions.includes("HMS-P-CTE-RW");
  const canApprove = allowedActions.includes("HMS-P-CTA-RW");
  const canDelete = allowedActions.includes("HMS-P-CTD-RW");
