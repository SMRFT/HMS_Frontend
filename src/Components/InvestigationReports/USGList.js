...
const USGList = ({
  ...
  const canEdit = allowedActions.includes("HMS-P-USGE-RW");
  const canApprove = allowedActions.includes("HMS-P-USGA-RW");
  const canDelete = allowedActions.includes("HMS-P-USGD-RW");
