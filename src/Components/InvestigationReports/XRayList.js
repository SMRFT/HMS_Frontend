...
const XRayList = ({
  ...
  const canEdit = allowedActions.includes("HMS-P-XRAYE-RW");
  const canApprove = allowedActions.includes("HMS-P-XRAYA-RW");
  const canDelete = allowedActions.includes("HMS-P-XRAYD-RW");
