...
const Summary = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch("https://hms.shinovadatabase.in/summaries/create/", {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        // Correct the URL
        fetch("https://hms.shinovadatabase.in/summaries/") // Ensure this is the correct API endpoint
            .then((response) => {
                if (!response.ok) {
    ...
    const handleDelete = (ipNo) => {
        if (window.confirm("Are you sure you want to delete this summary?")) {
            fetch(`https://hms.shinovadatabase.in/delete-summary/${ipNo}/`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleApprove = (ipNo) => {
        fetch(`https://hms.shinovadatabase.in/approve-summary/${ipNo}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
