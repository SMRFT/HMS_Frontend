...
const HeaderContainer = styled.div`
  ...
  position: fixed;
  top: 0;
  left: ${(props) => (props.$collapsed ? "0" : "260px")};
  right: 0;
  z-index: 5;
...
const App = () => {
  ...
  const isSpecialPage =
    location.pathname === "/login" || location.pathname === "/QRScan";

  if (isSpecialPage) {
    return (
      <div
        className={`App ${
          location.pathname === "/login" ? "login-page" : "qr-scan-page"
        }`}
      >
        ...
        <SidebarContainer $collapsed={sidebarCollapsed}>
          {!sidebarCollapsed && (
            <>
              ...
              <MenuItem
                onClick={() => toggleMenu("enquiryDesk")}
                $isActive={isActive("/Enquiry")}
              >
                <MenuItemContent>
                  <IconWrapper>
                    <Search size={20} />
              ...
              {expandedMenus.enquiryDesk && (
                <SubMenu>
                  <SubMenuItem to="/Enquiry" $isActive={isActive("/Enquiry")}>
                    Enquiry
                  </SubMenuItem>
                  <SubMenuItem
                    to="/EnquiryRoom"
                    $isActive={isActive("/EnquiryRoom")}
                  >
                    Rooms Availability
                  </SubMenuItem>
                </SubMenu>
              ...
              <MenuItem
                ...
                $isActive={
                  isMenuActive("/Patient") || isMenuActive("/Reference")
                }
              >
                <MenuItemContent>
                  <IconWrapper>
              ...
              {expandedMenus.frontOffice && (
                <SubMenu>
                  <SubMenuItem
                    to="/PatientRegistrationForm"
                    $isActive={isActive("/PatientRegistrationForm")}
                  >
                    Registration
                  </SubMenuItem>
                  <SubMenuItem
                    to="/Admission"
                    $isActive={isActive("/Admission")}
                  >
                    Admission
                  </SubMenuItem>
                </SubMenu>
              ...
              <MenuItem
                onClick={() => toggleMenu("frontOfficeMaster")}
                $isActive={
                  isMenuActive("/Patient") || isMenuActive("/Reference")
                }
              >
                <MenuItemContent>
                  ...
                  <MenuItemText>Front Office Master</MenuItemText>
                </MenuItemContent>
                {expandedMenus.frontOfficeMaster ? (
                  <ChevronUp size={18} />
                ) : (
                  <ChevronDown size={18} />
                )}
              ...
              {expandedMenus.frontOfficeMaster && (
                <SubMenu>
                  <SubMenuItem to="/Room" $isActive={isActive("/Room")}>
                    Rooms
                  </SubMenuItem>
                </SubMenu>
              )}
              ...
              <MenuItem
                ...
                $isActive={isMenuActive("/DischargeForm")}
              >
                <MenuItemContent>
                  <IconWrapper>
                    <Clipboard size={20} />
              ...
              {expandedMenus.inpatient && (
                <SubMenu>
                  ...
                  <SubMenuItem
                    to="/DischargeReport"
                    $isActive={isMenuActive("/DischargeReport")}
                  >
                    Discharge Report
                  </SubMenuItem>
                  <SubMenuItem
                    to="/DischargeBill"
                    $isActive={isMenuActive("/DischargeBill")}
                  >
                    Discharge Bill
                  </SubMenuItem>
                </SubMenu>
              ...
              {expandedMenus.pharmacy && (
                <SubMenu>
                  <SubMenuItem
                    to="/PharmacyBilling"
                    $isActive={isActive("/PharmacyBilling")}
                  >
                    Pharmacy Billing
                  </SubMenuItem>
                  <SubMenuItem
                    to="/StockEntry"
                    $isActive={isActive("/StockEntry")}
                  >
                    Stock Entry
                  </SubMenuItem>
                  <SubMenuItem
                    to="/StockDisplay"
                    $isActive={isActive("/StockDisplay")}
                  >
                    Stock Display
                  </SubMenuItem>
                  <SubMenuItem
                    to="/HSNCodeForm"
                    $isActive={isActive("/HSNCodeForm")}
                  >
                    HSN Code
                  </SubMenuItem>
                  <SubMenuItem
                    to="/VentorForm"
                    $isActive={isActive("/VentorForm")}
                  >
                    Vendor Form
                  </SubMenuItem>
                </SubMenu>
              ...
              <MenuItem
                ...
                $isActive={isMenuActive("/Doctor")}
              >
                <MenuItemContent>
                  <IconWrapper>
                    <User size={20} />
                  </IconWrapper>
                  <MenuItemText>Doctor Master</MenuItemText>
                </MenuItemContent>
              ...
              {expandedMenus.doctor && (
                <SubMenu>
                  <SubMenuItem to="/Doctor" $isActive={isActive("/Doctor")}>
                    Add Doctor
                  </SubMenuItem>
                  <SubMenuItem
                    to="/DoctorList"
                    $isActive={isMenuActive("/DoctorList")}
                  >
                    Doctor List
                  </SubMenuItem>
                </SubMenu>
              ...
              <MenuItem
                onClick={() => toggleMenu("radiology")}
                $isActive={isMenuActive("/CTList") || isMenuActive("/MRIList")}
              >
                <MenuItemContent>
                  <IconWrapper>
                    <Activity size={20} />
              ...
              {expandedMenus.radiology && (
                <SubMenu>
                  <SubMenuItem to="/CTList" $isActive={isMenuActive("/CTList")}>
                    CT Scan
                  </SubMenuItem>
                  <SubMenuItem
                    to="/MRIList"
                    $isActive={isMenuActive("/MRIList")}
                  >
                    MRI Scan
                  </SubMenuItem>
                  <SubMenuItem
                    to="/USGList"
                    $isActive={isMenuActive("/USGList")}
                  >
                    USG
                  </SubMenuItem>
                  <SubMenuItem
                    to="/XRayList"
                    $isActive={isMenuActive("/XRayList")}
                  >
                    X-Ray
                  </SubMenuItem>
                </SubMenu>
              )}
              <ModuleHeader>CLINICAL MODULES</ModuleHeader>
              <MenuItem
                onClick={() => toggleMenu("dischargeSummary")}
                $isActive={isMenuActive("/Summary")}
              >
                <MenuItemContent>
                  <IconWrapper>
                    <Clipboard size={20} />
                  </IconWrapper>
                  <MenuItemText>Discharge Summary</MenuItemText>
                </MenuItemContent>
                {expandedMenus.inpatient ? (
                  <ChevronUp size={18} />
                ) : (
              ...
              {expandedMenus.dischargeSummary && (
                <SubMenu>
                  <SubMenuItem
                    to="/Summary"
                    $isActive={isMenuActive("/Summary")}
