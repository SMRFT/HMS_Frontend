...
const OutPatientQRScan = () => {
    const baseUrl = window.location.origin + (process.env.PUBLIC_URL || "") + "/OutPatientfeedForm";
    ...
    return (
        <PageContainer>
            <QRCard>
                ...
                <Subtitle>
                    OUT PATIENT FEEDBACK FORM<br/>
                    அவுட்பேஷண்ட் கருத்துப் படிவம்
                </Subtitle>
                ...
                <div>
                    <QRImageWrapper>
                        <img
                            src={qrImageUrl}
                            alt="Shanmuga Hospital OutPatient Feedback QR Code"
                            width="240"
                            height="240"
                            style={{ display: "block" }}
                        />
...
export default OutPatientQRScan;
