            ...
            <form onSubmit={handleSubmit} className="border p-4 rounded shadow">
                <div className="row mb-3">
                    ...
                    <div className="col-md-2">
                        ...
                        <input type="text" name="ipNumber" value={formData.ipNumber} className="form-control" readOnly />
                    </div>
                ...
                <div className="row mb-3">
                    <div className="col-md-2">
                        ...
                        <input type="date" name="admissionDate" value={formData.admissionDate} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-2">
                    ...
                    <div className="col-md-2">
                        ...
                        <select name="customerType" value={formData.customerType} onChange={handleInputChange} className="form-select">
                    ...
                    <div className="col-md-3">
                        ...
                        <select name="admittingDoctor" value={formData.admittingDoctor} onChange={handleInputChange} className="form-select">
                    ...
                    <div className="col-md-3">
                        ...
                        <select name="consultingDoctor" value={formData.consultingDoctor} onChange={handleInputChange} className="form-select">
                            <option value="">Select Doctor</option>
                            {doctors.map((doctor) => (
                                <option
                                    key={doctor.id}
                ...
                <div className="row mb-3">
                    <div className="col-md-1">
                        ...
                        <input type="text" name="roomNo" value={formData.roomNo} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-1">
                        <label className="form-label">Bed No:</label>
                        <input type="text" name="bedNo" value={formData.bedNo} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-2">
                        <label className="form-label">Extension Number:</label>
                        <input type="text" name="extensionNumber" value={formData.extensionNumber} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-2">
                        <label className="form-label">Call Release:</label>
                        <select name="callRelease" value={formData.callRelease} onChange={handleInputChange} className="form-select">
                    ...
                    <div className="col-md-2">
                        ...
                        <input type="text" name="nursingStation" value={formData.nursingStation} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-4">
                        <label className="form-label">Present Complaints:</label>
                        <textarea name="presentComplaints" value={formData.presentComplaints} onChange={handleInputChange} className="form-control"></textarea>
                    </div>
                </div>
                ...
                <div className="row mb-3">
                    <div className="col-md-3">
                        ...
                        <textarea name="reasonForAdmission" value={formData.reasonForAdmission} onChange={handleInputChange} className="form-control"></textarea>
                    </div>
                    <div className="col-md-2">
                        <label className="form-label">Admission Fee:</label>
                        <input type="number" name="admissionFee" value={formData.admissionFee} onChange={handleInputChange} className="form-control" />
                    </div>
                    <div className="col-md-2">
                        <label className="form-label">Credit Limit:</label>
                        <input type="number" name="creditLimit" value={formData.creditLimit} onChange={handleInputChange} className="form-control" />
                    </div>
                </div>
                            ...
                            <div className="border p-3 rounded">
                                ...
                                <div className="mb-2">
                                    <div className="form-check">
                                        ...
                                        />
                                        <label className="form-check-label">Pass alert to authority</label>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div className="col-md-6">
                        ...
                        {newBornVisible && (
                            <div className="border p-3 rounded">
                                ...
                                <div>
                                    <label className="form-label">Pediatrician Responsible:</label>
                                    <select
                ...
                <div className="text-center">
                    <button type="button" onClick={handleReset} className="btn btn-secondary me-2">Reset</button>
