...
const ReferenceDoctorForm = ({ closeModal, setReferredBy }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://127.0.0.1:8000/reference-doctor/", formData);
      alert("Doctor added successfully!");
      setReferredBy(formData.doctor); // Set the referred doctor in the main form
