...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const connectionError = 'Failed to connect to the server. Please try again later.';
    ...
    <>
      ...
      <OuterContainer>
        <Container>
          ...
          <RightSection>
  <video autoPlay loop muted style={{ width: '100%', borderRadius: '15px', marginBottom: '20px' }}>
