...
import { Container, Typography, Card, CardContent, Grid, Box, Button, TextField, MenuItem } from '@mui/material';
...
function DoctorReport() {
    ...
    useEffect(() => {
        if (first_name) {
            axios.get(`http://localhost:8000/doctor_detail/${first_name}/`)
                .then(response => {
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.patch(`http://localhost:8000/doctor_detail/${first_name}/`, formData);
