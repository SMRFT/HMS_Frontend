...
function DoctorReport() {
    ...
    useEffect(() => {
        if (first_name) {
            axios.get(`https://hms.shinovadatabase.in/doctor_detail/${first_name}/`)
                .then(response => {
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.patch(`https://hms.shinovadatabase.in/doctor_detail/${first_name}/`, formData);
