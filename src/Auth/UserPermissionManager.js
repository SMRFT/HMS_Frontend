...
const EmployeeItem = styled.div`
  ...
  box-shadow: ${(props) =>
    props.active ? "0 4px 12px rgba(13, 148, 136, 0.25)" : "none"};
        ...
        perms.forEach((permToken) => {
          ...
          if (
            !groups[category].some(
              (p) => p.permId === permToken && p.pageName === page.name,
            )
          ) {
          ...
          {selectedEmpId ? (
                    ...
                    <div key={category}>
                      ...
                      <PermissionsGrid>
                        {groupedPermissions[category].map(
                          ({ pageName, route, permId, hasExplicitToken }) => {
                                ...
                                <PermText active={isActive}>
                                  ...
                                  >
                                    ...
                                    <span
                                      style={{
                                        fontSize: "0.65rem",
                                        background: hasExplicitToken
                                          ? "#dcfce7"
                                          : "#fef9c3",
                                        color: hasExplicitToken
                                          ? "#166534"
                                          : "#854d0e",
                                        borderRadius: "4px",
                                        padding: "2px 6px",
                                  ...
                                  <span>
                                    <FiExternalLink size={10} /> {pageName}
                                  </span>
                                </PermText>
            ...
            <EmptyState>
              ...
              <p style={{ color: "#64748b" }}>
                Select a user from the list to manage their access rights.
              </p>
            </EmptyState>
          )}
        </DetailPanel>
